package com.samples.spring.shared.events;
...
class PublishEventPostProcessor
  extends AbstractBeanFactoryAwareAdvisingPostProcessor
  implements InitializingBean {

  private final MethodInterceptor publishEventAdvice;

  public PublishEventPostProcessor(final ApplicationEventPublisher eventPublisher) {
